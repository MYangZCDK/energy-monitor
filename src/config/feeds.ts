...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  energy: [
    ...
    // Chinese Energy News
    { name: '中国电力新闻', url: rss('https://news.google.com/rss/search?q=电力+中国+能源&hl=zh-CN&gl=CN&ceid=CN:zh-CN') },
    { name: '光伏行业', url: rss('https://news.google.com/rss/search?q=光伏+太阳能+新能源&hl=zh-CN&gl=CN&ceid=CN:zh-CN') },
    { name: '风电行业', url: rss('https://news.google.com/rss/search?q=风电+风力发电+清洁能源&hl=zh-CN&gl=CN&ceid=CN:zh-CN') },
    { name: '储能行业', url: rss('https://news.google.com/rss/search?q=储能+锂电池+电池&hl=zh-CN&gl=CN&ceid=CN:zh-CN') },
  ],
};
